...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await login(useEmail ? email : null, useEmail ? null : mobile, password)
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Login to track your daily calories</p>
        </div>
